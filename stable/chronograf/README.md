...
```bash
$ helm install spc/chronograf --name foo namespace bar
```
...
```bash
$ helm install --name my-release spc/chronograf
```
...
```bash
$ helm install --name my-release -f values.yaml spc/chronograf
```
