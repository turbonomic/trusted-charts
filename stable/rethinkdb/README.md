...
**It is based on Helm community chart [rethinkdb](https://github.com/kubernetes/charts/tree/master/stable/rethinkdb)**
...
```console
$ helm upgrade rethinkdb tc/rethinkdb \
  --set rethinkdbPassword=new-password
```
...
```console
$ kubectl delete pvc -l release=rethinkdb
```
...
```console
$ kubectl get pods -l release=rethinkdb
NAME                                          READY     STATUS    RESTARTS   AGE
rethinkdb-rethinkdb-cluster-0                1/1       Running   0          1m
rethinkdb-rethinkdb-cluster-1                1/1       Running   0          2m
rethinkdb-rethinkdb-cluster-2                1/1       Running   0          2m
rethinkdb-rethinkdb-proxy-2517940628-81dxd   1/1       Running   1          1m

$ kubectl exec -it rethinkdb-rethinkdb-cluster-0 -- ps aux | grep 'rethinkdb'
...
$ kubectl exec -it rethinkdb-rethinkdb-cluster-0 -- kill 7
```
...
```console
$ helm upgrade rethinkdb tc/rethinkdb --set cluster.replicas=4
```
